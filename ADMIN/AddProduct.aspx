                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="drpcate" runat="server" CssClass="txt" 
                                ForeColor="#006600">
                                <asp:ListItem>SELECT JEWELLERY</asp:ListItem>
                                <asp:ListItem>Diamond Ring</asp:ListItem>
                                <asp:ListItem>Gold Ring</asp:ListItem>
                                <asp:ListItem>RoseGold Ring</asp:ListItem>
                                <asp:ListItem>Diamond Bracelet</asp:ListItem>
                                <asp:ListItem>Gold Bracelet</asp:ListItem>
                                <asp:ListItem>RoseGold Bracelet</asp:ListItem>
                                <asp:ListItem>Diamond Necklace</asp:ListItem>
                                <asp:ListItem>Gold Necklace</asp:ListItem>
                                 <asp:ListItem>RoseGold Necklace</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
